...
HD_PWD='C:/Users/Thomas/Desktop/TP_MISTRE/TP_FPGA/TP1/FIR5/FIR5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_DAC_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_DAC_top.tcl -notrace
