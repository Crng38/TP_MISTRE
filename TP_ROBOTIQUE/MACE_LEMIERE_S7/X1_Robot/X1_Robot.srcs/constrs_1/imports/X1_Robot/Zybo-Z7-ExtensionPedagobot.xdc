...
##Clock signal
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { H2 }]; #Signal de l'horloge
...
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33     } [get_ports { PWM3}]; #PWM moteur gauche
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { PWM2 }]; #PWM moteur gauche
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33     } [get_ports { Couleur_S0 }];   
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports { DIR2 }]; #Direction moteur droit
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33     } [get_ports { DIR3}]; #Direction moteur gauche
