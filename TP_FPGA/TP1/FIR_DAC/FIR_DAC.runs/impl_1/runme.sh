...
HD_PWD='C:/Users/Thomas/Desktop/TP_MISTRE/TP_FPGA/TP1/FIR_DAC/FIR_DAC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_DAC_top_original.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIR_DAC_top_original.tcl -notrace
