...
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { capture_IP_0 }]; #IO_L9P_T1_DQS_34 Sch=sw[3] #Switch pour enable
...
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { CIF_IP_0 }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3] #Signal de sortie pour CIF
...
##Pmod Header JD                                                                                                                  
#set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { wave_out[7] }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
