...
HD_PWD='C:/Users/Thomas/Desktop/TP_MISTRE/TP_ROBOTIQUE/test_sur_7010_fpga/test_sur_7010_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_mesure_vitesse_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_mesure_vitesse_wrapper.tcl
