...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L dsp_macro_v1_0_1 -L xil_defaultlib -L secureip -L xpm --snapshot dsp_mult16 xil_defaultlib.dsp_mult16 -log elaborate.log
}
