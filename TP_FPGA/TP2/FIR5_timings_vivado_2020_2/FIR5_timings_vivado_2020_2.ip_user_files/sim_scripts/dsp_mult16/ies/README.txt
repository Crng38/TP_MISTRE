...
#
# Generated by export_simulation on Mon Nov 14 18:53:33 +0100 2022
#
################################################################################
...
'-reset_run' switch to the './dsp_mult16.sh' script.

./dsp_mult16.sh -reset_run
...
./dsp_mult16.sh -noclean_files

For more information on the script, please type './dsp_mult16.sh -help'.
