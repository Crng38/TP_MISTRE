...
HD_PWD='C:/Users/Thomas/Desktop/TP_MISTRE/TP_SOC/Timer_IP/Timer_IP.runs/design_1_myipTimer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myipTimer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myipTimer_0_0.tcl
