...
HD_PWD='C:/Users/Thomas/Desktop/TP_MISTRE/TP_FPGA/TP1/FIR5/FIR5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIR_DAC_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIR_DAC_top.tcl
