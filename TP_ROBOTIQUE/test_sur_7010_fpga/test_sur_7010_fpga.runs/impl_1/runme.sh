...
HD_PWD='C:/Users/Thomas/Desktop/TP_MISTRE/TP_ROBOTIQUE/test_sur_7010_fpga/test_sur_7010_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_mesure_vitesse_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_mesure_vitesse_wrapper.tcl -notrace
