...
HD_PWD='C:/Users/Matt/Desktop/Git/TP_MISTRE/TP_ROBOTIQUE/MACE_LEMIERE_S7/X1_Robot/X1_Robot.runs/design_1_PWM_D_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PWM_D_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PWM_D_0.tcl
