...
--               c:/Users/Thomas/Desktop/TP_MISTRE/TP_ROBOTIQUE/test_sur_7010_fpga/test_sur_7010_fpga.gen/sources_1/bd/test_mesure_vitesse/ip/test_mesure_vitesse_signal_gene_0_0/test_mesure_vitesse_signal_gene_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of test_mesure_vitesse_signal_gene_0_0_signal_gene is
  ...
  signal \cpt_int[6]_i_1_n_0\ : STD_LOGIC;
  signal \cpt_int[6]_i_3_n_0\ : STD_LOGIC;
  signal \cpt_int[6]_i_4_n_0\ : STD_LOGIC;
  signal cpt_int_reg : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal p_0_in : STD_LOGIC_VECTOR ( 6 downto 1 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of clk_out_INST_0_i_1 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \cpt_int[6]_i_4\ : label is "soft_lutpair1";
begin
clk_out_INST_0: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => cpt_int_reg(2),
      I4 => cpt_int_reg(5),
      I5 => clk_out_INST_0_i_1_n_0,
      O => clk_out
    );
clk_out_INST_0_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\cpt_int[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\cpt_int[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"ABAAAAAA"
    )
        port map (
      ...
      I2 => cpt_int_reg(1),
      I3 => cpt_int_reg(6),
      I4 => \cpt_int[6]_i_3_n_0\,
      O => \cpt_int[6]_i_1_n_0\
    );
\cpt_int[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6AAAAAAAAAAAAAAA"
    )
        port map (
      I0 => cpt_int_reg(6),
      I1 => \cpt_int[6]_i_4_n_0\,
      I2 => cpt_int_reg(5),
      I3 => cpt_int_reg(4),
      I4 => cpt_int_reg(3),
      I5 => cpt_int_reg(2),
...
\cpt_int[6]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
      ...
      I2 => cpt_int_reg(3),
      I3 => cpt_int_reg(2),
      O => \cpt_int[6]_i_3_n_0\
    );
\cpt_int[6]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\cpt_int_reg[6]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
entity test_mesure_vitesse_signal_gene_0_0 is
  ...
  attribute NotValidForBitStream of test_mesure_vitesse_signal_gene_0_0 : entity is true;
